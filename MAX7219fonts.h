...
* - coding: utf-8 -
* -----------------------------------------------------------
* Filename: MAX7219fonts.h
* -----------------------------------------------------------
* Fonts data for use by the MAX7219matrix.cpp library
* 
* V1.0 by Michael Haugk
* 
* based on MAX7219fonts.py by JLC Archibald
* -----------------------------------------------------------
* Structure:
...
const char SINCLAIRS_FONT[256][8] = {
  { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }, // 0x00
